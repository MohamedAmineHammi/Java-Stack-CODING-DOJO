...
<section class="vh-100"
	...
	<form:form action="/teams/edit/${team.id}" method="POST" modelAttribute="team">
		...
		<input type="hidden" name="playersCount" value="${team.playersCount}">
		...
		<div class="form-group d-flex align-items-center">
			...
			<form:input type="number" class="form-control" id="skill" path="skill_level"/>
		</div>
		<br>
	 ...
	 <p class="mt-5"><a href="/delete/${team.id}" class="btn btn-dark">delete</a></p>
	</div>
