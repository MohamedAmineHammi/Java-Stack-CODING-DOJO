package com.codingdojo.taskproject.controllers;
...
import com.codingdojo.taskproject.models.LoginUser;
import com.codingdojo.taskproject.models.Task;
import com.codingdojo.taskproject.models.User;
import com.codingdojo.taskproject.services.TaskService;
import com.codingdojo.taskproject.services.UserService;
...
public class MainController {
	...
	public String home_by_priority(Model model, HttpSession session,
	...
	public String updateStatus(@RequestParam(value = "status") String status,
			@RequestParam(value = "taskId") Long taskId, HttpSession session) {
